        ...
        <div id="invoice-item-${invoiceItemCount}" class="mt-8"> <hr>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="invoiceItems[${invoiceItemCount}][description]"
                                class="form-control"
                                placeholder="Masukan keterangan invoice item" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="number" name="invoiceItems[${invoiceItemCount}][stock]" id="invoice-item-${invoiceItemCount}-stock"
                                class="form-control" placeholder="Masukan stock invoice item" required>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="file" name="invoiceItems[${invoiceItemCount}][images][]" class="form-control" multiple required>
                        </div>
                        <div class="col-md-6">
                            <label for="price" class="form-label fs-4 fw-bold">Harga Satuan</label>
                            <input type="number" name="invoiceItems[${invoiceItemCount}][price]"  id="invoice-item-${invoiceItemCount}-price" class="form-control" placeholder="Masukan harga satuan" required>
                        </div>
                    </div>
                    <div class="mt-3">
                        <label for="nominal" class="form-label fs-4 fw-bold">Nominal</label>
                        <input type="number" name="invoiceItems[${invoiceItemCount}][nominal]" id="invoice-item-${invoiceItemCount}-nominal"  class="form-control" placeholder="0">
                    </div>
        </div>
    `;
