...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl footer-offset">
    ...
    <script src="{{ asset('dist') }}/assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js" "></script>
                        ...
                        @if (Auth::user()->is_admin)
                            ...
                            <div class="nav-item  mt-2">
                                <a href="{{ route('admin.invoice.index') }}"
                                    ...
                                    <span class="nav-link-title mt-2 ms-3 fw-bold">Invoice</span>
                                </a>
                            </div>
                        @else
                            <div class="nav-item  mt-2">
    ...
    <main id="content" role="main" class="main bg-light mb-5" style="max-width: 100%">
        {{ $slot }}
