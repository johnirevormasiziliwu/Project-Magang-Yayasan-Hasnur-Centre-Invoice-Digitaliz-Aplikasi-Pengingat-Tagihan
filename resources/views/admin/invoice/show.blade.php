<x-app-layout>
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
            <h1 class="text-center" style="font-size: 3rem;">Detail Data-Data Invoice PDF</h1>
        </div>
                ...
                <div class="text-end">
                    @if(Auth::user()->is_admin)
                        ...
                        <a href="{{ route('admin.invoice.index') }}" class="btn fs-5 me-5"
                            style="border-color: #6e11f4; color: white">
                            Kembali </a>
                        </div>

                    @else 
                        <a href="{{ route('user.invoice.index') }}" class="btn fs-5 me-5"
                            style="border-color: #6e11f4; background: #6e11f4; color: white">
                            Kembali </a>
                        </div>
                    @endif
