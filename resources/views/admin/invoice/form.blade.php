                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="invoice_number" id="invoice_number"
                            ...
                            value="{{ old('invoice_number') }}" placeholder="inputkan ID invoice">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="inputkan judul invoice">
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="invoiceItems[0][description]"  class="form-control"
                                        placeholder="inputkan keterangan invoice tagihan" required>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="invoiceItems[0][stock]"  id="stock" class="form-control"
                                        placeholder="inputkan kuantitas invoice tagihan" required>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="invoiceItems[0][price]" id="price" class="form-control"
                                        placeholder="inputkan harga invoice tagihan" required>
                                </div>
                            </div>
                            <div class="mt-3 mb-3">
