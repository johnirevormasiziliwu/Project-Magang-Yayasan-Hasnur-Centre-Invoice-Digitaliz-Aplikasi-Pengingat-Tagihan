...
class InvoicePaidNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ...
                    ->line("Saya berharap email ini menemukan Anda dalam keadaan sehat dan baik-baik saja. Saya ingin mengingatkan Anda bahwa faktur kami nomor ".$this->invoice->invoice_number." ".$this->invoice->invoice_id." berjudul ".$this->invoice->title." dengan tanggal jatuh tempo pada tanggal ".date('d F Y', strtotime($this->invoice->due_date))." masih belum dibayarkan.")
                    ...
                    ->action('Download Invoice', route('admin.download-invoice', $invoice))
                    ->line("Hormat Kami")
